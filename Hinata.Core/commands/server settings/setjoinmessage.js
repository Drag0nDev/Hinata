...
module.exports = {
    ...
    examples: [
        'h!sjm Welcome %mention% to **%server%**! You are the **%member%th** member.',
        'h!sjm {"color": "#00ff00","title": "New member join","description": "Welcome %mention% to **%server%**!","fields": [{"name": "membercount","value": "%members%"}],"thumbnail": "%avatar%"}'
    ],
