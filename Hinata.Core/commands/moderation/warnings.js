...
module.exports = {
    ...
    description: 'This command shows the warnings depending on the input.\n' +
        ...
        '- `Hinata warns all` shows all the warns logged for the server.\n' +
        '- `Hinata warns [member mention/id]` shows all the warns of a user.',
    usage: '[command | alias] [Member mention/id]',
    examples: ['h!warns @Drag0n#6666', 'h!warns 418037700751261708', 'h!warns all'],
