...
const pat = require('../../misc/reactions.json').pat;
...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (reaction.members.length === 0) {
            ...
            reaction.text = `*Pats* ${reaction.author}!`;
        } else
            reaction.text = `${reaction.members}you have been patted by **${reaction.author.nickname === null ? reaction.author.user.username : reaction.author.nickname}**!`;
...
function getGif() {
    return pat[getRandom(pat.length)];
}
